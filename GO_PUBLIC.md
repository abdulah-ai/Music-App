# Taking SuperMedia public (no App Store, no Play Store)
...
They get the SuperMedia orb icon, a splash screen, full-screen standalone mode
...
- App name **SuperMedia**, package `com.supermediaapp.mobile`
