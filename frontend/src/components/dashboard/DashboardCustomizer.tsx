...
const styles = StyleSheet.create({
  ...
  handle: { alignSelf: 'center', width: 36, height: 4, borderRadius: 2, backgroundColor: 'rgba(167,176,168,0.3)', marginBottom: spacing.md },
  ...
  segmented: { flexDirection: 'row', backgroundColor: 'rgba(5,8,5,0.5)', borderRadius: radii.pill, padding: 3 },
  segment: { flex: 1, paddingVertical: spacing.sm, borderRadius: radii.pill, alignItems: 'center' },
  segmentActive: { backgroundColor: 'rgba(47,191,170,0.18)' },
  segmentLabel: { ...typography.caption, fontSize: 13, color: colors.textMuted },
  segmentLabelActive: { color: colors.cyan, fontFamily: 'SpaceGrotesk_600SemiBold' },
  widgetRow: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: spacing.sm,
    ...
    backgroundColor: 'rgba(18,28,24,0.4)',
  },
  ...
  moveButton: { width: 28, height: 28, alignItems: 'center', justifyContent: 'center', borderRadius: radii.pill, backgroundColor: 'rgba(5,8,5,0.4)' },
